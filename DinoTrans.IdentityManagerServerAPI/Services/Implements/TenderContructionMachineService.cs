...
{
    public class TenderContructionMachineService : ITenderContructionMachineService
    {
        private readonly ITenderRepository _tenderRepository;
        private readonly ITenderContructionMachineRepository _tendercontructionMachineRepository;

        public TenderContructionMachineService(
            ITenderRepository tenderRepository,
            ITenderContructionMachineRepository tendercontructionMachineRepository)
        {
            _tenderRepository = tenderRepository;
            _tendercontructionMachineRepository = tendercontructionMachineRepository;
        }

        public async Task<GeneralResponse> CreateTenderContructionMachine(UpdateTenderStep2AndCreateTenderContructionMachineDTO dto)
        {
            try
            {
